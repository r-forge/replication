...
\section{Introduction}
  \begin{block}{}
  \begin{center}
  \color{uzh@blue}{\huge \textbf{The Statistical Assessment of 
  Replication Success}\\[1cm]
  \Large{Lecture by Leonhard Held}} 
   \end{center}
  \end{block}
\end{frame}
...
\section{Introduction}
  \begin{block}{}
  \begin{center}
  \color{uzh@blue}{\huge \textbf{The Design and Analysis of Replication Studies}
  \\[1cm]
  \Large{Workshop by Leonhard Held and Charlotte Micheloud}} 
   \end{center}
  \end{block}
\end{frame}
...
\section{More advanced topics}
  % \begin{block}{}
  \begin{center}
  \color{uzh@blue}{\Huge \textbf{More advanced topics (not covered in Geneva)}}
   \end{center}
  % \end{block}
\end{frame}
...
\begin{frame}[fragile]{Interim power}
  \framesubtitle{in the package}
  \begin{block}{SSRP dataset}
<<>>=
# dataset 
data("SSRP")
@
...
\begin{frame}{Interested to participate?}
  \begin{block}{Swiss Reproducibility Network}
   \begin{center}
    \includegraphics[width=3cm]{images_presentation/SwissRNLogowide.png} \\
    \end{center}
  \end{block}
    \pause
  \begin{block}{Swiss Reproducibility Network {\color{red} Academy}}
    \begin{itemize}
  ...
  \item {\color{red} First event:} Friday, Feb 25 (16:00 - 17:15) - online
  \item {\color{red} Interested in joining?} please email 
  \begin{center}
  \url{swissrnacademy@gmail.com}
  \end{center}
    \end{itemize}
  \end{block}
